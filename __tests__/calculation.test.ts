...
describe('With child (for tax year 2022)', () => {
  test('should map child', () => {
    ...
    expect(result.r033[0].priezviskoMeno).toBe('Johnny Bravo')
    expect(result.r033[0].rodneCislo).toBe('1507011234')
    expect(result.r033[0].m00).toBe(false)
    expect(result.r033[0].m01).toBe(false)
    expect(result.r033[0].m02).toBe(true)
    expect(result.r033[0].m03).toBe(true)
    expect(result.r033[0].m04).toBe(true)
    expect(result.r033[0].m05).toBe(true)
    expect(result.r033[0].m06).toBe(true)
    expect(result.r033[0].m07).toBe(true)
    expect(result.r033[0].m08).toBe(true)
    expect(result.r033[0].m09).toBe(true)
    expect(result.r033[0].m10).toBe(true)
    expect(result.r033[0].m11).toBe(false)
    expect(result.r033[0].m12).toBe(false)
  })
  ...
  test('should map child with wholeYear', () => {
    ...
    expect(result.r033[0].priezviskoMeno).toBe('Johnny Bravo')
    expect(result.r033[0].rodneCislo).toBe('1507011234')
    expect(result.r033[0].m00).toBe(true)
    expect(result.r033[0].m01).toBe(false)
    expect(result.r033[0].m02).toBe(false)
    expect(result.r033[0].m03).toBe(false)
    expect(result.r033[0].m04).toBe(false)
    expect(result.r033[0].m05).toBe(false)
    expect(result.r033[0].m06).toBe(false)
    expect(result.r033[0].m07).toBe(false)
    expect(result.r033[0].m08).toBe(false)
    expect(result.r033[0].m09).toBe(false)
    expect(result.r033[0].m10).toBe(false)
    expect(result.r033[0].m11).toBe(false)
    expect(result.r033[0].m12).toBe(false)
  })
