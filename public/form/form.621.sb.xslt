...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
	...
	<xsl:template match="/dokument/telo">
		...
		<xsl:apply-templates select="./r50a"/>
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		...
		<xsl:apply-templates select="./r54a"/>
		<xsl:apply-templates select="./r55"/>
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>Uplatnenie odpočtu výdavkov (nákladov) na výskum a vývoj podľa § 30c zákona a odpočtu výdavkov (nákladov) na investície podľa § 30e zákona na podporu športu podľa § 30ca zákona (vypĺňa sa aj príloha č. 1, resp. aj príloha č. 1b, resp. aj príloha č. 1c)</xsl:text>
		...
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>XI. ODDIEL - ĎALŠIE ÚDAJE O DAŇOVNÍKOVI</xsl:text>
		<xsl:apply-templates select="./r145"/>
		<xsl:apply-templates select="./r146"/>
		<xsl:apply-templates select="./r146a"/>
		...
		<xsl:apply-templates select="./r154"/>
		...
		<xsl:apply-templates select="./pril1cPar30caVydavkySport"/>
		<xsl:apply-templates select="./pril2PodielyNaZisku"/>
		<xsl:apply-templates select="./pril3VynosyZDlhopisov"/>
	...
	<xsl:template match="/dokument/telo/tabulka1b/t1r2">
		...
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>2 Pohľadávky</xsl:text>
		<xsl:apply-templates select="./s1"/>
		<xsl:apply-templates select="./s2"/>
	</xsl:template>
	...
	<xsl:template match="/dokument/telo/r52">
		<xsl:if test="./text()">
			...
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>52 Uplatnenie daňovej straty vykázanej za rok 2021, najviac do sumy uvedenej v r. 4 stĺpec 48, maximálne však do sumy zodpovedajúcej kladnému rozdielu súm uvedených v r. 45 a r. 51 : </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/tabulka3/t3r16">
		...
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>16 príjmy z predaja kryptoaktíva</xsl:text>
		<xsl:apply-templates select="./s1"/>
		<xsl:apply-templates select="./s2"/>
	</xsl:template>
	...
	<xsl:template match="/dokument/telo/r151">
		...
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>151 &#218;DAJE O PRIJ&#205;MATEĽOVI</xsl:text>
		<xsl:apply-templates select="./ico"/>
		<xsl:apply-templates select="./splnam3per"/>
		<xsl:apply-templates select="./neuplatnujemPar50"/>
		<xsl:apply-templates select="./obchodneMeno"/>
		<xsl:apply-templates select="./suhlasSoZaslanim"/>
	</xsl:template>
	<xsl:template match="/dokument/telo/r153">
		...
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>153 - ÚDAJE O RODIČOVI / RODIČOCH</xsl:text>
		<xsl:apply-templates select="./neuplatnujemPar50aa"/>
		<xsl:apply-templates select="./rodicA"/>
		<xsl:apply-templates select="./rodicB"/>
		<xsl:apply-templates select="./bolZverenyDoStarostlivosti"/>
	</xsl:template>
	...
	<xsl:template match="/dokument/telo/pril1cPar30caVydavkySport">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>PRÍLOHA č. 1c - Odpočet výdavkov (nákladov) na podporu športu podľa § 30ca zákona</xsl:text>
		<xsl:apply-templates select="./r01"/>
		<xsl:apply-templates select="./r02"/>
		<xsl:apply-templates select="./r03"/>
		<xsl:apply-templates select="./r04"/>
	...
	<xsl:template match="/dokument/telo/pril1cPar30caVydavkySport/r01">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril1cPar30caVydavkySport/r02">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril1cPar30caVydavkySport/r03">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril1cPar30caVydavkySport/r04">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril1cPar30caVydavkySport/r05">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril1cPar30caVydavkySport/r06">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>6 Odpočet podľa § 30ca ods. 1 zákona: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril1cPar30caVydavkySport/r07">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>7 Odpočet podľa § 30ca ods. 2 zákona : </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril1cPar30caVydavkySport/r08">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>8 SPOLU odpočet podľa § 30ca ods. 1 a 2 zákona (r. 6 + r. 7): </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril1cPar30caVydavkySport//s01Od">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril1cPar30caVydavkySport//s01Do">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril1cPar30caVydavkySport//s02">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>Výška vykázaného nároku na odpočet výdavkov (nákladov) na podporu športu podľa § 30ca ods. 1 zákona v zdaňovacom období: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril1cPar30caVydavkySport//s03">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr4">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr5">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr6">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr22">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr23">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr24">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>PRÍLOHA č. 3 - Výnosy (príjmy) zo štátnych dlhopisov a štátnych pokladničných poukážok, ktoré sú súčasťou osobitného základu dane podľa § 51ea zákona</xsl:text>
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/socZdravPoistenie">
		...
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>PRÍLOHA č. 4 - Údaje na účely sociálneho poistenia a zdravotného poistenia</xsl:text>
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r50a">
		<xsl:text>&#xA;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
		<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r50a/rok">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r50a/udaje/r02">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r50a/udaje/r04">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r53">
		<xsl:if test="./text()">
			...
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>53 Uplatnenie daňovej straty vykázanej za rok 2022, najviac do sumy uvedenej v r. 4 stĺpec 49, maximálne však do sumy zodpovedajúcej kladnému rozdielu sumy uvedenej v r.45 a súm na (r. 51+ r.52): </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/r54">
		<xsl:if test="./text()">
			...
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>54 Uplatnenie daňovej straty vykázanej za rok 2023, najviac do sumy uvedenej v r. 4 stĺpec 50, maximálne však do sumy zodpovedajúcej kladnému rozdielu sumy uvedenej v r. 45 a súm na (r.51 + r. 52 + r.53): </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/r54a">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>54a Uplatnenie daňovej straty vykázanej za rok 2024, najviac do sumy uvedenej v r. 4 stĺpec 50a, maximálne však do sumy zodpovedajúcej kladnému rozdielu sumy uvedenej v r. 45 a súm na (r. 51 + r. 52 + r. 53 + r. 54): </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/r55">
		<xsl:if test="./text()">
			...
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>55 Znížený čiastkový základ dane z príjmov podľa § 6 ods. 1 a 2 zákona o stratu z predchádzajúcich zdaňovacích období (r. 45 - r. 51 - r.52 - r. 53 - r. 54 - r. 54a): </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/r56">
		<xsl:if test="./text()">
			...
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>56 Odpočet výdavkov (nákladov) na výskum a vývoj podľa § 30c zákona a na investície podľa § 30e zákona a na podporu športu podľa § 30ca zákona maximálne do sumy uvedenej v r. 55 (r. 9 prílohy č. 1 + r. 11 prílohy č. 1b + r. 8 prílohy č. 1c): </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/r57">
		<xsl:if test="./text()">
			...
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>57 Základ dane (čiastkový základ dane) z príjmov podľa § 6 ods. 1 a 2 zákona znížený o odpočet výdavkov (nákladov) na výskum a vývoj a na investície a na podporu športu (r. 55 - r. 56): </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/r116">
		<xsl:if test="./text()">
			...
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>116 Daň (daňová povinnosť) zo základu dane zisteného podľa § 4 zákona, z osobitného základu dane podľa § 7 zákona a z osobitného základu dane podľa § 51e zákona (r. 90 + r. 105 + r. 115 + r. 28 Prílohy č. 2 + r. 14 prílohy č. 3): </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/r122">
		<xsl:if test="./text()">
			...
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text disable-output-escaping="yes">122 Suma daňového bonusu podľa zákona vyplatená zamestnávateľom nesprávne alebo vo vyššej sume r. 119 - r. 117 &gt; 0: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/r140">
		<xsl:if test="./text()">
			...
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text disable-output-escaping="yes">140 Daň na úhradu (+) alebo daňový preplatok (-) (r. 135 alebo r. 136) - r. 139 + [(r. 152 daňového priznania33) - 2% alebo 3% z r. 124) &gt; 0]34) alebo (r. 135 alebo r. 136) - r. 139 + [(r. 82 daňového priznania typ A33) - 2% alebo 3% z r. 124) &gt; 0]34) alebo (r. 135 alebo r. 136) - r. 139 + [(r. 13 vyhlásenia o poukázaní sumy podielu zaplatenej dane - 2% alebo 3% z r. 124) &gt; 0]: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/r146a">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			...
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>146a úhrn všetkých zdaniteľných príjmov plynúcich zo zdrojov na území Slovenskej republiky: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/r151/ico">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r151/obchodneMeno">
	...
	<xsl:template match="/dokument/telo/r151/splnam3per">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r151/neuplatnujemPar50">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r151/suhlasSoZaslanim">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>súhlasím so zaslaním údajov (meno, priezvisko a trvalý pobyt) mnou určenému prijímateľovi podielu zaplatenej dane uvedenému v r. 151 podľa § 50 ods. 8 zákona: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/r152">
		<xsl:if test="./text()">
			...
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>152 2 % alebo 3 % zo zaplatenej dane (minimálne 3 eurá) z r. 124: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/r153/neuplatnujemPar50aa">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r153/rodicA/rodneCislo">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r153/rodicA/priezvisko">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r153/rodicA/meno">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r153/rodicB/rodneCislo">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r153/rodicB/priezvisko">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r153/rodicB/meno">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r153/bolZverenyDoStarostlivosti">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/r154">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>154 Počet pr&#237;loh: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/danovyPreplatokBonus/sposobPlatby/poukazka">
		<xsl:if test="./text()">
			...
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>poštovou pouk&#225;žkou (do výšky 15 000 eur vrátane): </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr1">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr2">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr3">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr4/s1">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr4/s2">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr5/s1">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr5/s2">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr6/s1">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr6/s2">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr7">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr8">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr9">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr10">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr11">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr12">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr13">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr14">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr15">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr16">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr17">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr18">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr19">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr20">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr21">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr22/s1">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr22/s2">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr23/s1">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr23/s2">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr24/s1">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr24/s2">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr25">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr26">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr27">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril2PodielyNaZisku/pr28">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov/pr1">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>01 Výnosy (príjmy) zo štátnych dlhopisov a štátnych pokladničných poukážok : </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov/pr2">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>02 Výnosy (príjmy) vyplácané z dlhopisov a pokladničných poukážok vydaných iným členským štátom Európskej únie alebo štátom, ktorý je zmluvnou stranou Dohody o Európskom hospodárskom priestore okrem výnosov (príjmov) vyplácaných daňovníkovi podľa § 43 ods. 3písm. i) a v) zákona: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov/pr3">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>03 Osobitný základ dane podľa § 51ea zákona r. 01 + r. 02: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov/pr4">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>04 Sadzba dane (v %): </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov/pr5">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>05 Daň z osobitného základu dane vypočítaná sadzbou dane podľa § 15 písm. a) siedmeho bodu zákona (r. 03 x r. 04) : 100: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov/pr6">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>Výpočet dane po vyňatí výnosov (príjmov) vyplácaných z dlhopisov a pokladničných poukážok vydaných iným členským štátom Európskej únie alebo štátom, ktorý je zmluvnou stranou Dohody o Európskom hospodárskom priestore, okrem výnosov (príjmov) vyplácaných daňovníkovi podľa § 43 ods. 3 písm. i) a v) zákona zo zdrojov v zahraničí, ktoré sú súčasťou osobitného základu dane podľa § 51ea zákona</xsl:text>
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text disable-output-escaping="yes">06 Úhrn vyňatých výnosov (príjmov) z dlhopisov a pokladničných poukážok (základov dane), ktoré sú súčasťou príjmov uvedených v r. 03: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov/pr7">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text disable-output-escaping="yes">07 Osobitný základ dane podľa § 51ea zákona znížený o úhrn vyňatých výnosov (príjmov) vyplácaných z dlhopisov a pokladničných poukážok (r. 03 - r. 06): </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov/pr8">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>08 Daň po vyňatí výnosov (príjmov) a z dlhopisov a pokladničných poukážok (základov dane) zo zdrojov v zahraničí (r. 07 x r. 04) : 100: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov/pr9">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>Výpočet dane uznanej na zápočet na daňovú povinnosť v tuzemsku zo zaplatenej dane v zahraničí z výnosov (príjmov) vyplácaných z dlhopisov a pokladničných poukážok vydaných iným členským štátom Európskej únie alebo štátom, ktorý je zmluvnou stranou Dohody o Európskom hospodárskom priestore, okrem výnosov (príjmov) vyplácaných daňovníkovi podľa § 43 ods. 3 písm. i) a v) zákona zo zdrojov v zahraničí, ktoré sú súčasťou osobitného základu dane podľa § 51ea zákona</xsl:text>
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>09 Úhrn výnosov (príjmov) vyplácaných z dlhopisov a pokladničných poukážok (základov dane), ktoré sú súčasťou osobitného základu dane uvedeného v r. 03: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov/pr10">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>10 Daň zaplatená v zahraničí z príjmov z r. 09 - uvádza sa suma zaplatenej dane podľa zmluvy o zamedzení dvojitého zdanenia: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov/pr11">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>11 Výpočet percenta dane na účely zápočtu r. 09 : [(r. 03 - r. 06) alebo r. 03] x 100: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov/pr12">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>12 Z dane zaplatenej v zahraničí možno započítať [(r. 08 alebo r. 05) x r. 11] : 100: </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov/pr13">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>13 Daň uznaná na zápočet (r. 12 maximálne do sumy v r. 10): </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;'" />
	...
	<xsl:template match="/dokument/telo/pril3VynosyZDlhopisov/pr14">
		<xsl:if test="./text()">
			<xsl:text>&#xA;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>&#09;</xsl:text>
			<xsl:text>14 Daň z osobitného základu dane podľa § 51ea zákona po vyňatí a zápočte (r. 08 alebo r. 05) alebo (r. 08 - r. 13 alebo r. 05 - r. 13): </xsl:text>
			<xsl:call-template name="string-replace-all">
				<xsl:with-param name="text" select="." />
				<xsl:with-param name="replace" select="'&#10;'" />
				<xsl:with-param name="by" select="'&#13;&#10;&#09;&#09;&#09;'" />
