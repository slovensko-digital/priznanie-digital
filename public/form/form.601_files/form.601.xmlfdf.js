...
function createxmlfinal() {
    ...
    stringBuilder.appendLine('\t</adresaTrvPobytu>');
    stringBuilder.appendLine('\t<nerezident>');
    stringBuilder.appendLine('\t\t<nerezident>' + (document.getElementById("cbNerezident").checked ? '1' : '0') + '</nerezident>');
    stringBuilder.appendLine('\t\t<datumOd>' + htmlEncode($('#nerezidentOd').val()) + '</datumOd>');
    stringBuilder.appendLine('\t\t<datumDo>' + htmlEncode($('#nerezidentDo').val()) + '</datumDo>');
    stringBuilder.appendLine('\t\t<TIN>' + htmlEncode($('#TIN').val()) + '</TIN>');
    stringBuilder.appendLine('\t\t</nerezident>');
    ...
    for (; i <= repeatingCount; i++) {
        ...
        stringBuilder.appendLine('\t\t\t<priezviskoMeno>' + htmlEncode(getPageValue1Xml(i, 'r33Priezvisko_1')) + '</priezviskoMeno>');
        stringBuilder.appendLine('\t\t\t<rodneCislo>' + htmlEncode(getPageValue1Xml(i, 'r33RodCislo_2a')) + htmlEncode(getPageValue1Xml(i, 'r33RodCislo_2b')) + '</rodneCislo>');
    ...
    stringBuilder.appendLine('\t<datumUzavretiaZmluvyOUvere>' + htmlEncode($('#datumZmluvaUver').val()) + '</datumUzavretiaZmluvyOUvere>');
    stringBuilder.appendLine('\t</r35>');

    // V. Oddiel
    stringBuilder.appendLine('\t<r36>' + htmlEncode($('#r36').val()) + '</r36>');
    stringBuilder.appendLine('\t<r36a>' + htmlEncode($('#r36a').val()) + '</r36a>');
    stringBuilder.appendLine('\t<r37>' + htmlEncode($('#r37').val()) + '</r37>');
    ...
    stringBuilder.appendLine('\t\t</t1r13>');
    stringBuilder.appendLine('\t</tabulka1>');
    stringBuilder.appendLine('\t<mikrodanovnikPar2w>' + (document.getElementById("cbMicroDanovnik").checked ? '1' : '0') + '</mikrodanovnikPar2w>');
    ...
    stringBuilder.appendLine('\t\t</t1r5>');
    stringBuilder.appendLine('\t\t<t1r6>');
    stringBuilder.appendLine('\t\t\t<s1>' + htmlEncode($('#t1aR6S1').val()) + '</s1>');
    stringBuilder.appendLine('\t\t\t<s2>' + htmlEncode($('#t1aR6S2').val()) + '</s2>');
    stringBuilder.appendLine('\t\t</t1r6>');
    stringBuilder.appendLine('\t</tabulka1a>');
    ...
    stringBuilder.appendLine('\t<r39>' + htmlEncode($('#t39').val()) + '</r39>');
    stringBuilder.appendLine('\t<r40>' + htmlEncode($('#t40').val()) + '</r40>');
    ...
    stringBuilder.appendLine('\t<r48>');
    stringBuilder.appendLine('\t\t<rok>2021</rok>');
    stringBuilder.appendLine('\t\t<udaje>');
    stringBuilder.appendLine('\t\t\t<r02>' + htmlEncode($('#R2_48').val()) + '</r02>');
    stringBuilder.appendLine('\t\t\t<r03>' + htmlEncode($('#R3_48').val()) + '</r03>');
    stringBuilder.appendLine('\t\t\t<r04>' + htmlEncode($('#R4_48').val()) + '</r04>');
    stringBuilder.appendLine('\t\t</udaje>');
    stringBuilder.appendLine('\t</r48>');
    ...
    stringBuilder.appendLine('\t<r139>' + htmlEncode($('#t139').val()) + '</r139>');
    stringBuilder.appendLine('\t<r140>' + htmlEncode($('#t140').val()) + '</r140>');
    stringBuilder.appendLine('\t<r141>' + htmlEncode($('#t141').val()) + '</r141>');
    stringBuilder.appendLine('\t<r142>' + htmlEncode($('#t142').val()) + '</r142>');
    ...
    for (var z = 1; z <= 10; z++) {//10 rovnakych riadkov
        if (z < 10) {
        ...
        stringBuilder.appendLine('\t\t\t<s03>' + htmlEncode($('#Pri1br' + z + 'Stlpec3').val()) + '</s03>');
        stringBuilder.appendLine('\t\t\t<s04>' + htmlEncode($('#Pri1br' + z + 'Stlpec4').val()) + '</s04>');
        if (z < 10) {
            stringBuilder.appendLine('\t\t</r0' + z + '>');
        } else {
            stringBuilder.appendLine('\t\t</r' + z + '>');
    ...
    stringBuilder.appendLine('\t\t<r11>' + htmlEncode($('#Pri1br11Spolu').val()) + '</r11>');
    stringBuilder.appendLine('\t\t<r12>' + htmlEncode($('#Pri1br12Plan').val()) + '</r12>');
    ...
    for (var i = 0; i < hlavicka.childNodes.length; i++) {
        ...
        switch (aNode.nodeName) {
            ...
            case 'nerezident':
                for (var j = 0; j < aNode.childNodes.length; j++) {
                    var bNode = aNode.childNodes[j];
                    if (bNode.nodeName == "nerezident") $("#cbNerezident").attr("checked", (getNodeValue(bNode) == '1' ? true : false)).change();
                    if (bNode.nodeName == "datumOd") $('#nerezidentOd').val(getNodeValue(bNode));
                    if (bNode.nodeName == "datumDo") $('#nerezidentDo').val(getNodeValue(bNode));
                    if (bNode.nodeName == "TIN") $('#TIN').val(getNodeValue(bNode));
                }
        ...
        switch (aNode.nodeName) {
                ...
                for (var j = 0; j < aNode.childNodes.length; j++) {
                    ...
                    if (bNode.nodeName == "dieta") {
                        ...
                        for (var k = 0; k < bNode.childNodes.length; k++) {
                            ...
                            if (cNode.nodeName == "priezviskoMeno") setPageValue1Xml(dietaCount, 'r33Priezvisko_1', getNodeValue(cNode));
                            if (cNode.nodeName == "rodneCislo") {
                                if (getNodeValue(cNode).length >= 9) {
                                    setPageValue1Xml(dietaCount, 'r33RodCislo_2a', getNodeValue(cNode).substr(0, 6));
                                    setPageValue1Xml(dietaCount, 'r33RodCislo_2b', getNodeValue(cNode).substr(6));
                                } else {
                                    setPageValue1Xml(dietaCount, 'r33RodCislo_2a', getNodeValue(cNode).substr(0, 4));
                                    setPageValue1Xml(dietaCount, 'r33RodCislo_2b', getNodeValue(cNode).substr(4));
                                }
                            }
            ...
            case 'r35':
                for (var j = 0; j < aNode.childNodes.length; j++) {
                    ...
                    if (bNode.nodeName == "datumUzavretiaZmluvyOUvere") $('#datumZmluvaUver').val(getNodeValue(bNode));
                }
                break;
            ...
            case 'mikrodanovnikPar2w': document.getElementById("cbMicroDanovnik").checked = (getNodeValue(aNode) == '1' ? true : false); break;
            ...
            case 'tabulka1a':
                for (var j = 0; j < aNode.childNodes.length; j++) {
                    ...
                    if (bNode.nodeName == "t1r6") {
                        for (var k = 0; k < bNode.childNodes.length; k++) {
                            if (bNode.childNodes[k].nodeName == "s1") $('#t1aR6S1').val(getNodeValue(bNode.childNodes[k]));
                            if (bNode.childNodes[k].nodeName == "s2") $('#t1aR6S2').val(getNodeValue(bNode.childNodes[k]));
                        }
                    }
                }
                break;
            ...
            case 'r39': $('#t39').val(getNodeValue(aNode)); break;
            case 'r40': $('#t40').val(getNodeValue(aNode)); break;
            ...
            case 'r48':
                var udaje = aNode.getElementsByTagName('udaje')[0];
                $("#R2_48").val(getElementsValXml(udaje.getElementsByTagName('r02')[0]));
                $("#R3_48").val(getElementsValXml(udaje.getElementsByTagName('r03')[0]));
                $("#R4_48").val(getElementsValXml(udaje.getElementsByTagName('r04')[0]));
                break;
            case 'r49':
                var udaje = aNode.getElementsByTagName('udaje')[0];
            ...
            case 'r92': $('#t92').val(getNodeValue(aNode)); break;
            case 'r93': $('#t93').val(getNodeValue(aNode)); break;
            case 'r94': $('#t94').val(getNodeValue(aNode)); break;
            case 'r95': $('#t95').val(getNodeValue(aNode)); break;
            case 'r96': $('#t96').val(getNodeValue(aNode)); break;
            case 'r97': $('#t97').val(getNodeValue(aNode)).change(); break;
            case 'r98': $('#t98').val(getNodeValue(aNode)); break;
            case 'r99': $('#t99').val(getNodeValue(aNode)); break;
            case 'r100': $('#t100').val(getNodeValue(aNode)).change(); break;
            case 'r101': $('#t101').val(getNodeValue(aNode)); break;
            ...
            case 'r107': $('#t107').val(getNodeValue(aNode)).change(); break;
            case 'r108': $('#t108').val(getNodeValue(aNode)); break;
            case 'r109': $('#t109').val(getNodeValue(aNode)); break;
            case 'r110': $('#t110').val(getNodeValue(aNode)).change(); break;
            ...
            case 'r139': $('#t139').val(getNodeValue(aNode)); break;
            case 'r140': $('#t140').val(getNodeValue(aNode)); break;
            case 'r141': $('#t141').val(getNodeValue(aNode)); break;
            case 'r142': $('#t142').val(getNodeValue(aNode)); break;
            ...
            case 'prilPodielyNaZisku':
                for (var j = 0; j < aNode.childNodes.length; j++) {
                    ...
                    if (bNode.nodeName == "pr14") $('#tbPr2_14').val(getNodeValue(bNode)).change();
...
function createMainFdf() {
    ...
    stringBuilder.appendLine('    << /V (' + ($('#cbNerezident').is(':checked') ? 'X' : '') + ')/T (12a)>>');
    if (!!$('#nerezidentOd').val()) {
        stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#nerezidentOd').val().split(".")[0]) + ')/T (12b)>>');
    } else {
        stringBuilder.appendLine('    << /V ()/T (12b)>>');
    }
    if (!!$('#nerezidentOd').val()) {
        stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#nerezidentOd').val().split(".")[1]) + ')/T (12c)>>');
    } else {
        stringBuilder.appendLine('    << /V ()/T (12c)>>');
    }
    if (!!$('#nerezidentOd').val()) {
        stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#nerezidentOd').val().split(".")[2].substr(2, 2)) + ')/T (12d)>>');
    } else {
        stringBuilder.appendLine('    << /V ()/T (12d)>>');
    }
    if (!!$('#nerezidentDo').val()) {
        stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#nerezidentDo').val().split(".")[0]) + ')/T (12e)>>');
    } else {
        stringBuilder.appendLine('    << /V ()/T (12e)>>');
    }
    if (!!$('#nerezidentDo').val()) {
        stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#nerezidentDo').val().split(".")[1]) + ')/T (12f)>>');
    } else {
        stringBuilder.appendLine('    << /V ()/T (12f)>>');
    }
    if (!!$('#nerezidentDo').val()) {
        stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#nerezidentDo').val().split(".")[2].substr(2, 2)) + ')/T (12g)>>');
    } else {
        stringBuilder.appendLine('    << /V ()/T (12g)>>');
    }
    stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#TIN').val()) + ')/T (12h)>>');
    ...
    if (!!$('#r32_2').val()) {
        stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#r32_2').val().split(".")[1]) + ')/T (32c)>>');
    } else {
    ...
    for (i = 0; i < 4; i++) {
        ...
        stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#r33Priezvisko_1' + suffix).val()) + ')/T (33-' + (i + 1) + 'a)>>');
        stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#r33RodCislo_2a' + suffix).val()) + ')/T (33-' + (i + 1) + 'b)>>');
        stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#r33RodCislo_2b' + suffix).val()) + ')/T (33-' + (i + 1) + 'c)>>');
        stringBuilder.appendLine('    << /V (' + ($('#cbM00_1' + suffix).is(':checked') ? 'X' : '') + ')/T (33-' + (i + 1) + 'e00)>>');
        stringBuilder.appendLine('    << /V (' + ($('#cbM01_1' + suffix).is(':checked') ? 'X' : '') + ')/T (33-' + (i + 1) + 'e01)>>');
        stringBuilder.appendLine('    << /V (' + ($('#cbM02_1' + suffix).is(':checked') ? 'X' : '') + ')/T (33-' + (i + 1) + 'e02)>>');
        stringBuilder.appendLine('    << /V (' + ($('#cbM03_1' + suffix).is(':checked') ? 'X' : '') + ')/T (33-' + (i + 1) + 'e03)>>');
        stringBuilder.appendLine('    << /V (' + ($('#cbM04_1' + suffix).is(':checked') ? 'X' : '') + ')/T (33-' + (i + 1) + 'e04)>>');
        stringBuilder.appendLine('    << /V (' + ($('#cbM05_1' + suffix).is(':checked') ? 'X' : '') + ')/T (33-' + (i + 1) + 'e05)>>');
        stringBuilder.appendLine('    << /V (' + ($('#cbM06_1' + suffix).is(':checked') ? 'X' : '') + ')/T (33-' + (i + 1) + 'e06)>>');
        stringBuilder.appendLine('    << /V (' + ($('#cbM07_1' + suffix).is(':checked') ? 'X' : '') + ')/T (33-' + (i + 1) + 'e07)>>');
        stringBuilder.appendLine('    << /V (' + ($('#cbM08_1' + suffix).is(':checked') ? 'X' : '') + ')/T (33-' + (i + 1) + 'e08)>>');
        stringBuilder.appendLine('    << /V (' + ($('#cbM09_1' + suffix).is(':checked') ? 'X' : '') + ')/T (33-' + (i + 1) + 'e09)>>');
        stringBuilder.appendLine('    << /V (' + ($('#cbM10_1' + suffix).is(':checked') ? 'X' : '') + ')/T (33-' + (i + 1) + 'e10)>>');
        stringBuilder.appendLine('    << /V (' + ($('#cbM11_1' + suffix).is(':checked') ? 'X' : '') + ')/T (33-' + (i + 1) + 'e11)>>');
    ...
    if (!!$('#datumZmluvaUver').val()) {
        stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#datumZmluvaUver').val().split(".")[0]) + ')/T (35h)>>');
    } else {
        stringBuilder.appendLine('    << /V ()/T (35h)>>');
    }
    if (!!$('#datumZmluvaUver').val()) {
        stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#datumZmluvaUver').val().split(".")[1]) + ')/T (35i)>>');
    } else {
        stringBuilder.appendLine('    << /V ()/T (35i)>>');
    }
    if (!!$('#datumZmluvaUver').val()) {
        stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#datumZmluvaUver').val().split(".")[2].substr(2, 2)) + ')/T (35j)>>');
    } else {
        stringBuilder.appendLine('    << /V ()/T (35j)>>');
    }
    //V oddiel
    stringBuilder.appendLine('    << /V (' + celacast($('#r36').val()) + ')/T (36)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#r36').val(), 2) + ')/T (36d)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#r36a').val()) + ')/T (36a)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#r36a').val(), 2) + ')/T (36ad)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#r37').val()) + ')/T (37)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#r37').val(), 2) + ')/T (37d)>>');
    ...
    stringBuilder.appendLine('    << /V (' + ($('#cbMicroDanovnik').is(':checked') ? 'X' : '') + ')/T (mikrodanovnik)>>');
    ...
    stringBuilder.appendLine('    << /V (' + celacast($('#t1aR6S1').val()) + ')/T (t1a16)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#t1aR6S1').val(), 2) + ')/T (t1a16d)>>');
    ...
    stringBuilder.appendLine('    << /V (' + celacast($('#t1aR6S2').val()) + ')/T (t1a26)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#t1aR6S2').val(), 2) + ')/T (t1a26d)>>');
    //tabulka 1b
    ...
    stringBuilder.appendLine('    << /V (' + celacastabs($('#t81').val()) + ')/T (81)>>');
    ...
    stringBuilder.appendLine('    << /V (' + prepisznakyFdf(znamienko($('#t97').val())) + ')/T (97z)>>');
    stringBuilder.appendLine('    << /V (' + celacastabs($('#t97').val()) + ')/T (97)>>');
    ...
    stringBuilder.appendLine('    << /V (' + prepisznakyFdf(znamienko($('#t107').val())) + ')/T (107z)>>');
    stringBuilder.appendLine('    << /V (' + celacastabs($('#t107').val()) + ')/T (107)>>');
    ...
    stringBuilder.appendLine('    << /V (' + celacast($('#t128').val()) + ')/T (128)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#t128').val(), 2) + ')/T (128d)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#t129').val()) + ')/T (129)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#t129').val(), 2) + ')/T (129d)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#t130').val()) + ')/T (130)>>');
    ...
    stringBuilder.appendLine('    << /V (' + celacast($('#t132').val()) + ')/T (132)>>');
    ...
    stringBuilder.appendLine('    << /V (' + celacast($('#t134').val()) + ')/T (134)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#t134').val(), 2) + ')/T (134d)>>');

    //XI. oddiel
    stringBuilder.appendLine('    << /V (' + celacast($('#t135').val()) + ')/T (135)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#t135').val(), 2) + ')/T (135d)>>');
    ...
    stringBuilder.appendLine('    << /V (' + prepisznakyFdf(znamienko($('#t138').val())) + ')/T (138z)>>');
    stringBuilder.appendLine('    << /V (' + celacastabs($('#t138').val()) + ')/T (138)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#t138').val(), 2) + ')/T (138d)>>');
    stringBuilder.appendLine('    << /V (' + prepisznakyFdf(znamienko($('#t139').val())) + ')/T (139z)>>');
    stringBuilder.appendLine('    << /V (' + celacastabs($('#t139').val()) + ')/T (139)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#t139').val(), 2) + ')/T (139d)>>');
    stringBuilder.appendLine('    << /V (' + prepisznakyFdf(znamienko($('#t140').val())) + ')/T (140z)>>');
    stringBuilder.appendLine('    << /V (' + celacastabs($('#t140').val()) + ')/T (140)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#t140').val(), 2) + ')/T (140d)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#t141').val()) + ')/T (141)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#t141').val(), 2) + ')/T (141d)>>');
    stringBuilder.appendLine('    << /V (' + prepisznakyFdf(znamienko($('#t142').val())) + ')/T (142z)>>');
    stringBuilder.appendLine('    << /V (' + celacastabs($('#t142').val()) + ')/T (142)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#t142').val(), 2) + ')/T (142d)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#t143').val()) + ')/T (143)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#t143').val(), 2) + ')/T (143d)>>');
    stringBuilder.appendLine('    << /V (' + prepisznakyFdf(znamienko($('#t144').val())) + ')/T (144z)>>');
    stringBuilder.appendLine('    << /V (' + celacastabs($('#t144').val()) + ')/T (144)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#t144').val(), 2) + ')/T (144d)>>');
    ...
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#t148').val(), 2) + ')/T (148d)>>');
    stringBuilder.appendLine('    << /V (' + ($('#t149').is(':checked') ? 'X' : '') + ')/T (149)>>');
    stringBuilder.appendLine('    << /V (' + prepisznakyFdf($('#t150').val()) + ')/T (150)>>');
    ...
    stringBuilder.appendLine('    << /V (' + ($('#chbRekreacia').is(':checked') ? 'X' : '') + ')/T (uplatnujem)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#valRekreacia').val()) + ')/T (vyska)>>');
    ...
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#tbPr2S1_01').val(), 2) + ')/T (ozd011d)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#tbPr2S1_02').val()) + ')/T (ozd021)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#tbPr2S1_02').val(), 2) + ')/T (ozd021d)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#tbPr2S1_03').val()) + ')/T (ozd031)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#tbPr2S1_03').val(), 2) + ')/T (ozd031d)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#tbPr2S1_04').val()) + ')/T (ozd041)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#tbPr2S1_04').val(), 2) + ')/T (ozd041d)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#tbPr2S1_05').val()) + ')/T (ozd051)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#tbPr2S1_05').val(), 2) + ')/T (ozd051d)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#tbPr2S1_06').val()) + ')/T (ozd061)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#tbPr2S1_06').val(), 2) + ')/T (ozd061d)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#tbPr2S2_04').val()) + ')/T (ozd042)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#tbPr2S2_04').val(), 2) + ')/T (ozd042d)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#tbPr2S2_05').val()) + ')/T (ozd052)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#tbPr2S2_05').val(), 2) + ')/T (ozd052d)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#tbPr2S2_06').val()) + ')/T (ozd062)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#tbPr2S2_06').val(), 2) + ')/T (ozd062d)>>');

    stringBuilder.appendLine('    << /V (' + celacast($('#tbPr2_07').val()) + ')/T (ozd07)>>');
    stringBuilder.appendLine('    << /V (' + desatinnacast($('#tbPr2_07').val(), 2) + ')/T (ozd07d)>>');
    stringBuilder.appendLine('    << /V (' + celacast($('#tbPr2_08').val()) + ')/T (ozd08)>>');
