...
export const validateUrokyBonusForm = (
  ...
  const rok_uzatvorenia = Number.parseInt(values.uroky_zmluva_rok_uzatvorenia, 10)
  const mesiac_uzatvorenia = Number.parseInt(values.uroky_zmluva_mesiac_uzatvorenia, 10)
  const den_uzatvorenia = Number.parseInt(values.uroky_zmluva_den_uzatvorenia, 10)

  const den_urocenia = Number.parseInt(values.uroky_zaciatok_urocenia_den, 10)
  const mesiac_urocenia = Number.parseInt(values.uroky_zaciatok_urocenia_mesiac, 10)
  const rok_urocenia = Number.parseInt(values.uroky_zaciatok_urocenia_rok, 10)

  const zaciatok_urocenia = new Date(rok_urocenia, mesiac_urocenia - 1, den_urocenia)
  const datum_uzatvorenia = new Date(rok_uzatvorenia, mesiac_uzatvorenia - 1, den_uzatvorenia)
