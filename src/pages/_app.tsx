...
const MyApp = ({
  ...
  useEffect(() => {
    ...
    validateRoute(router, taxForm, taxFormUserInput, postponeUserInput, isDebug, isLive, isPostponeLive)
  }, [router, nextRoute, taxForm, taxFormUserInput, postponeUserInput, isLive, isPostponeLive])
